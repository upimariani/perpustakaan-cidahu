			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form role="form" action="<?= base_url('cKelolaDataMaster/update_buku/' . $buku->id_buku) ?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8">

							<div class="card-body">
								<div class="form-group">
									<label for="exampleInputPassword1">No. ISBN</label>
									<input type="text" name="isbn" value="<?= $buku->no_isbn ?>" class="form-control" id="exampleInputPassword1" placeholder="Masukkan No ISBN">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Sampul Buku</label><br>
									<img style="width: 200px;" src="<?= base_url('asset/sampul/' . $buku->sampul) ?>">
								...
								<div class="form-group">
									...
									<input type="number" name="jml" value="<?= $buku->jml_buku ?>" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Jumlah Buku">
								</div>
							</div>
							<!-- /.card-body -->
