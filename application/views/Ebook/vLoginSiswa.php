...
<body style="background-image: url('<?= base_url('asset/1.jpg') ?>'); " class="hold-transition login-page">
	<div class="login-box">
		<!-- /.login-logo -->
		<div class="card">
			<div class="card-body login-card-body">
				...
				<form action="<?= base_url('cLearning/login_siswa') ?>" method="post" id="quickForm">

					<div class="card-body">
						<div class="form-group">
							<label for="exampleInputPassword1">NIS</label>
							<input type="text" name="nis" class="form-control" id="exampleInputPassword1" placeholder="Enter NIS" required>
						</div>
						<div class="form-group">
