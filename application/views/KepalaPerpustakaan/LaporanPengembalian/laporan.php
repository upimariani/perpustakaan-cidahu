			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card card-warning">
						...
						<div class="card-body">
							<?php
							echo form_open('KepalaPerpustakaan/cLaporanPengembalian/lap_harian') ?>
							<div class="row">
								<div class="col-sm-4">
				...
				<div class="col-md-4">
					<div class="card card-warning">
						...
						<div class="card-body">
							<?php
							echo form_open('KepalaPerpustakaan/cLaporanPengembalian/lap_bulanan') ?>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Bulan</label>
				...
				<div class="col-md-4">
					<div class="card card-warning">
						...
						<div class="card-body">
							<?php
							echo form_open('KepalaPerpustakaan/cLaporanPengembalian/lap_tahunan') ?>
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label>Tahun</label>
